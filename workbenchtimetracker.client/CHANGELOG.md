...
- Create Angular project with ng: `ng new workbenchtimetracker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`workbenchtimetracker.client.esproj`).
